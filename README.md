# Task List APP
Aplicativo web de lista de tarefas que permite o cadastros de novas tarefas, a edição delas podemos mudar seu titulo e o seu status de concluída ou não, e também permite excluir um tarefa.
...
### Desenvolvido com:
-	Asp Net Core 2.2 - O framework utilizando para desenvolver a API Rest.
...
-	Visual Studio 2019 – Usado para desenvolvimento Back-End.
